...
export type circle = Array<number>;
...
export interface Exports {
  to(format: "csv", parameters?: {download?: boolean, filename?: string, callback?: ((exportContent: any) => void), what: string, which?: Array<Id>, separator?: string, textSeparator?: string, categoriesName?: string}): Promise<string>;
  to(format: "gexf", parameters?: {download?: boolean, filename?: string, callback?: ((exportContent: any) => void), creator?: string, description?: string}): Promise<string>;
  to(format: "graphml", parameters?: {download?: boolean, filename?: string, callback?: ((exportContent: any) => void), graphId?: string, directedEdges?: boolean}): Promise<string>;
  to(format: "json", parameters?: {download?: boolean, filename?: string, callback?: ((exportContent: any) => void), nodeFields?: Array<string>, edgeFields?: Array<string>, pretty?: boolean}): Promise<string>;
  to(format: "png", parameters?: {download?: boolean, filename?: string, callback?: ((exportContent: any) => void), clip?: boolean, margin?: number, width?: number, height?: number, size?: number, background?: Color, texts?: boolean, map?: boolean, textWatermark?: {content: string, fontSize?: string, fontStyle?: string, fontColor?: Color, repeat?: boolean, angle?: number, alpha?: number, space?: number, x?: number, y?: number}|string, imageWatermark?: {content: string, width: number, height: number, repeat?: boolean, angle?: number, alpha?: number, space?: number, x?: number, y?: number}}): Promise<string>;
  to(format: "jpg", parameters?: {download?: boolean, filename?: string, callback?: ((exportContent: any) => void), clip?: boolean, margin?: number, width?: number, height?: number, size?: number, background?: Color, texts?: boolean, map?: boolean, textWatermark?: {content: string, fontSize?: string, fontStyle?: string, fontColor?: Color, repeat?: boolean, angle?: number, alpha?: number, space?: number, x?: number, y?: number}|string, imageWatermark?: {content: string, width: number, height: number, repeat?: boolean, angle?: number, alpha?: number, space?: number, x?: number, y?: number}}): Promise<string>;
  to(format: "tiff", parameters?: {download?: boolean, filename?: string, callback?: ((exportContent: any) => void), clip?: boolean, margin?: number, width?: number, height?: number, size?: number, background?: Color, texts?: boolean, map?: boolean, textWatermark?: {content: string, fontSize?: string, fontStyle?: string, fontColor?: Color, repeat?: boolean, angle?: number, alpha?: number, space?: number, x?: number, y?: number}|string, imageWatermark?: {content: string, width: number, height: number, repeat?: boolean, angle?: number, alpha?: number, space?: number, x?: number, y?: number}}): Promise<string>;
  to(format: "gif", parameters?: {download?: boolean, filename?: string, callback?: ((exportContent: any) => void), clip?: boolean, margin?: number, width?: number, height?: number, size?: number, background?: Color, texts?: boolean, map?: boolean, textWatermark?: {content: string, fontSize?: string, fontStyle?: string, fontColor?: Color, repeat?: boolean, angle?: number, alpha?: number, space?: number, x?: number, y?: number}|string, imageWatermark?: {content: string, width: number, height: number, repeat?: boolean, angle?: number, alpha?: number, space?: number, x?: number, y?: number}}): Promise<string>;
  to(format: "svg", parameters?: {download?: boolean, filename?: string, callback?: ((exportContent: any) => void), clip?: boolean, margin?: number, width?: number, height?: number, size?: number, background?: Color, texts?: boolean}): Promise<string>;
  to(format: "xlsx", parameters?: {download?: boolean, filename?: string, callback?: ((exportContent: any) => void), what: string, which?: Array<Id>}): Promise<any>;
}
...
export interface Layouts {
  ...
  start(layoutName: "radial", layoutParams?: {centralNode: Id, nodes?: Array<Id>, centerX?: number, centerY?: number, allowOverlap?: boolean, repulsion?: number, radiusDelta?: number, radiusRatio?: number, nodeGap?: number, maxIterations?: number, iterationsPerRender?: number, renderSteps?: boolean, epsilon?: number}, syncParameters?: {duration?: number, onSync?: (() => void), onEnd?: (() => void), useWebWorker?: boolean}): Promise<void>;
  stop(): void;
  isRunning(): boolean;
}
...
export interface Settings {
  ...
  get(moduleName: "geo", autoUpdate?: boolean): {latitudePath?: string, longitudePath?: string, sizeZoomReferential?: number, maxZoomLevel?: number, tileUrlTemplate?: string, tileUrlSubdomains?: string, tileBuffer?: number, attribution?: string, backgroundColor?: Color, opacity?: number, transitionDuration?: Color, backgroundFadingDuration?: Color, detectRetina?: boolean};
  ...
  update(moduleName: "geo", settings?: {latitudePath?: string, longitudePath?: string, sizeZoomReferential?: number, maxZoomLevel?: number, tileUrlTemplate?: string, tileUrlSubdomains?: string, tileBuffer?: number, attribution?: string, backgroundColor?: Color, opacity?: number, transitionDuration?: Color, backgroundFadingDuration?: Color, detectRetina?: boolean}): void;
  ...
  reset(moduleName: "geo", settings?: {latitudePath?: string, longitudePath?: string, sizeZoomReferential?: number, maxZoomLevel?: number, tileUrlTemplate?: string, tileUrlSubdomains?: string, tileBuffer?: number, attribution?: string, backgroundColor?: Color, opacity?: number, transitionDuration?: Color, backgroundFadingDuration?: Color, detectRetina?: boolean}): void;
...
export interface Topology {
  ...
  getConnectedComponents(returnIds?: boolean): void;
  getConnectedComponentByNode(node: Node|NodeId, returnIds?: boolean): void;
}
